...
class PrizeManager
{
    ...
    static potentialCars = [
        ...
        new Prize("LEXUS ES", 43190, "blue"),
        new Prize("AUDI A7", 73295, "black"),
        new Prize("GENESIS G80", 58350, "green"),
        new Prize("BMW 5 SERIES", 59375, "gray"),
        new Prize("ACURA TLX", 46595, "white"),
        new Prize("CADILLAC CT5", 48990, "maroon"),
        new Prize("MERCEDES-BENZ C-CLASS", 49600, "red"),
        new Prize("HONDA ACCORD", 29390, "purple"),
        new Prize("TOYOTA CAMRY", 29795, "fuchsia"),
        new Prize("KIA K5", 28145, "olive"),
        new Prize("HYUNDAI SONATA", 27800, "yellow"),
        new Prize("NISSAN ALTIMA", 28140, "teal"),
        new Prize("SUBARU LEGACY", 26180, "brown"),
        new Prize("CHEVROLET MALIBU", 26995),
    ];
